...
<meta charset="utf-8"/>
	...
	<style>
		#carouselExampleIndicators .carousel-inner .carousel-item{
			background: url('https://wallpaperaccess.com/full/2311974.jpg');
		...
		#carouselExampleIndicators .carousel-inner .carousel-item:nth-child(2){
			background: url('https://wallpaperaccess.com/thumb/1104816.jpg');
			background-size: 100% 100%;
	        background-position: center;
	        background-attachment: fixed;
		}
		...
		#carouselExampleIndicators .carousel-inner .carousel-item:nth-child(3){
			background: url('https://pettubadi.in/wp-content/uploads/2017/12/Bank-Inv.jpg');
			background-size: 100% 100%;
	background-position: center;
	background-attachment: fixed;
		}
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><b>VIRTUAL BANK</b></a>
			  ...
			  <div class="carousel-inner">
			    <div class="carousel-item active">
					...
					<h1>Welcome to Virtual Bank</h1>
			      	<p><b> bank you can actually like</b></p>
